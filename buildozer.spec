...
source.exclude_dirs = .git,.venv,venv,__pycache__,tests,.scratch,.buildozer,.docs,.opencode,.agents,.pytest_cache,bin,drive-cache,frames,assets
...
presplash.filename = %(source.dir)s/assets/android/presplash_portrait.jpg
...
android.add_resources = %(source.dir)s/assets/android/res
android.api = 33
android.minapi = 24
